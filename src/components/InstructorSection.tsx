...
const InstructorSection = () => (
  <section className="relative py-10 md:py-24 overflow-hidden bg-background text-foreground">
    ...
    <div className="pointer-events-none absolute top-1/3 -right-32 w-[480px] h-[480px] rounded-full bg-primary/5 blur-3xl" aria-hidden="true" />
    {/* bottom fade for smooth transition into the dark section below */}
    <div className="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-b from-transparent to-[hsl(220_60%_5%)]/15" aria-hidden="true" />
    <div
